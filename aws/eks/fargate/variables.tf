# Variables for EKS Fargate Cluster
variable "region" {
...
variable "fargate_namespace" {
  description = "Kubernetes namespace to schedule onto Fargate"
  type        = string
  default     = "default"
}
...
variable "private_subnet_cidrs" {
  description = "CIDR blocks for private subnets used by EKS, Fargate and node groups"
  type        = list(string)
